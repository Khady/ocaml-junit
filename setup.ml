...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8fb600ea3d01b74094a7768ac89f3e40) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/Khady/ocaml-junit";
          synopsis = "Library to produce XML JUnit reports.";
          description =
            Some [OASISText.Para "Library to produce XML JUnit reports."];
          categories = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/Khady/ocaml-junit.git";
                      src_repo_browser =
                        Some "https://github.com/Khady/ocaml-junit";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "junit"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "examples";
                      test_run =
                        [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/junit";
                      doc_title = "API reference for JUnit";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "^\188\161<\155\251\199\130m\164\b\142\250\251\244\164";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
